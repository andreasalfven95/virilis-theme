...
function virilis_theme_setup()
{
	...
	/* add_image_size( "featured-thumbnail", 1920, 1920 ); */
...
{
	if (!is_single()) {
		$more = sprintf('<button class="button-primary"><a href="%1$s">%2$s</a></button>', get_permalink(get_the_ID()), __("Read more...", "virilis_theme"));
	}
	return $more;
}
